...
const Home = () => {
  ...
  const testimonials = [
    {
      ...
      role: 'Farmer',
      location: 'पंजाब',
      content: 'AgriConnect platform has revolutionized my farming business. I get better prices and direct access to buyers.',
      rating: 5
    },
    {
      name: 'अमित शर्मा',
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900">
            ...
            >
              {!user ? (
                <>
                  <Link
                    to="/register"
                    className="inline-flex items-center justify-center px-8 py-4 border border-transparent text-base font-medium rounded-md text-white bg-primary-600 hover:bg-primary-700 transition-colors duration-200"
                  >
                    Get Started
                  ...
                  <Link
                    to="/grains"
                    className="inline-flex items-center justify-center px-8 py-4 border border-primary-600 text-base font-medium rounded-md text-primary-600 dark:text-primary-400 bg-transparent hover:bg-primary-50 dark:hover:bg-gray-800 transition-colors duration-200"
                  >
                    Browse Grains
                  </Link>
                </>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <div className="aspect-w-4 aspect-h-3">
                <div className="bg-gradient-to-br from-primary-400 to-secondary-600 rounded-lg flex items-center justify-center text-white">
      ...
      {/* CTA Section */}
      <section className="py-24 bg-gradient-to-r from-primary-600 to-secondary-600 dark:from-primary-700 dark:to-secondary-700">
          ...
          >
            ...
            {!user && (
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link
                  to="/register"
                  className="inline-flex items-center justify-center px-8 py-4 border-2 border-white text-base font-medium rounded-md text-primary-600 bg-white hover:bg-gray-50 transition-colors duration-200"
                >
                  Start Trading Today
                  <ArrowRightIcon className="ml-2 h-5 w-5" />
                </Link>
